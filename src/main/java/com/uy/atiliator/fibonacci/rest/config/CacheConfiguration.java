package com.uy.atiliator.fibonacci.rest.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("fibonacciRest");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("fibonacciRest");
        ...
        config.getMapConfigs().put("com.uy.atiliator.fibonacci.rest.domain.*", initializeDomainMapConfig(jHipsterProperties));
